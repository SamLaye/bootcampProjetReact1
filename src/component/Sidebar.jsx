...
export default function Sidebar({munuItems}) {
  ...
  return (
    <div className='bg-white border border-grey  mx-0 ' id='sidebar'>
        ...
        <div className='mt-5'>
            ...
            {
            munuItems.map((items) => (
                <li className=' list-unstyled p-4 fw-bold fs-5' id={items.list} >
        ...
        <div className='mt-5'>
            <h5>PREFERENCES</h5>
            <ul>
                <li className='list-unstyled p-4 fw-bold fs-5'>
